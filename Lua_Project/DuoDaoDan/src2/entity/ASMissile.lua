...
local ASMissile = class("ASMissile", function ()
    return cc.Sprite:createWithSpriteFrameName("M_02-1_silver.png")
end)
...
--    cache:addSpriteFrames("Images/missileFire.plist","Images/missileFire.png")
--    -- 喷火动画
--    local animFrames = {}
--    for i=1, 2 do
--        local frame = cache:getSpriteFrame(string.format("fire0%d.png",i))
--    	animFrames[i] = frame
--    end
--    local animation = cc.Animation:createWithSpriteFrames(animFrames,0.2)
--    local animate = cc.Animate:create(animation)
--    
--    local fire = cc.Sprite:create()
--    fire:runAction(cc.RepeatForever:create(animate))
--    self:addChild(fire)
--    fire:setPosition(self:getContentSize().width/2,-30)

...
local ASGameOver = require("scene.ASGameOverScene")
...
function ASMainGameScene:createMapLayer()
    ...
    local center = cc.Sprite:createWithSpriteFrameName("xuedi.jpg")
...
function ASMainGameScene:createGameLayer()
    ...
    -- 添加玩家飞机精灵
    local player = cc.Sprite:createWithSpriteFrameName("PlaneOne.png")
...
--------------- 测试label-------------------------------------------
--  local curLabel = cc.Label:createWithTTF("curr:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(curLabel)
--  curLabel:setPosition(cc.p(430,origin.y+50))
--  curLabel:setColor(cc.c3b(0,0,0))
--    
--  local TouchLabel = cc.Label:createWithTTF("touch:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(TouchLabel)
--  TouchLabel:setPosition(cc.p(430,origin.y+20))  
--  TouchLabel:setColor(cc.c3b(0,0,0))
--  
--  local curLabel = cc.Label:createWithTTF(curLabelText,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(curLabel)
--  curLabel:setPosition(cc.p(480,origin.y+50))  
--  curLabel:setColor(cc.c3b(0,0,0))  
--  
--  local TouchLabel = cc.Label:createWithTTF(touLabelText,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(TouchLabel)
--  TouchLabel:setPosition(cc.p(480,origin.y+20))  
--  TouchLabel:setColor(cc.c3b(0,0,0))
--------------------- 导弹角度测试------------------------------
--  local M_curLabel = cc.Label:createWithTTF("MCur:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(M_curLabel)
--  M_curLabel:setPosition(cc.p(540,origin.y+50))
--  M_curLabel:setColor(cc.c3b(0,0,0))  
--  
--  local M_ReqLabel = cc.Label:createWithTTF("MTar:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(M_ReqLabel)
--  M_ReqLabel:setPosition(cc.p(540,origin.y+20))
--  M_ReqLabel:setColor(cc.c3b(0,0,0))
--  
--  M_curLabelText = cc.Label:createWithTTF(m_CurLabelText,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(M_curLabelText)
--  M_curLabelText:setPosition(cc.p(600,origin.y+50))
--  M_curLabelText:setColor(cc.c3b(0,0,0))
--  ASGlobalClient.M_curLabelText = M_curLabelText
--  
--  M_TarLabelText = cc.Label:createWithTTF(touLabelText,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(M_TarLabelText)
--  M_TarLabelText:setPosition(cc.p(600,origin.y+20))
--  M_TarLabelText:setColor(cc.c3b(0,0,0))
--  ASGlobalClient.M_TarLabelText = M_TarLabelText
--  
--  local planeWorldX = cc.Label:createWithTTF("planeWorldX:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(planeWorldX)
--  planeWorldX:setPosition(cc.p(size.width/4,origin.y+50))
--  planeWorldX:setColor(cc.c3b(0,0,0))
--  
--  local planeWorldY = cc.Label:createWithTTF("planeWorldY:","fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(planeWorldY)
--  planeWorldY:setPosition(cc.p(size.width/4,origin.y+20))
--  planeWorldY:setColor(cc.c3b(0,0,0))
-- 
--  gameLayer:addChild(planeWorldY)
--  planeWorldY:setPosition(cc.p(size.width/4,origin.y+20))
--  planeWorldY:setColor(cc.c3b(0,0,0))
--  
--  planeWorldXTextL = cc.Label:createWithTTF(planeWorldPositionX,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(planeWorldXTextL)
--  planeWorldXTextL:setPosition(cc.p(planeWorldX:getPositionX()+100,origin.y+50))
--  planeWorldXTextL:setColor(cc.c3b(0,0,0))
--  
--  planeWorldYTextL = cc.Label:createWithTTF(planeWorldPositionY,"fonts/Marker Felt.ttf",20)
--  gameLayer:addChild(planeWorldYTextL)
--  planeWorldYTextL:setPosition(cc.p(planeWorldY:getPositionX()+100,origin.y+20))
--  planeWorldYTextL:setColor(cc.c3b(0,0,0))
-----------------------------------------------------------------------------------------  
    if currentLanguageType == cc.LANGUAGE_CHINESE then
        ...
        distanceLabel = cc.Label:createWithBMFont("fonts/ziti.fnt","Distance:")
        distanceText = cc.Label:createWithBMFont("fonts/ziti.fnt",distance.."m")
    end 
    ...
    function flyStateUpdate()       
        ...
        if _state == FlyState.NORMAL then
            ...
            if isYellowSelect == false then
                player:setSpriteFrame("PlaneOne.png")
            else
                player:setSpriteFrame("planeGlod.png")
            end   
        elseif _state == FlyState.LEFT then
            x = -1      
            if rotA < 5 then                
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneLeft0.png")
                else
                    player:setSpriteFrame("planeGlodLeft0.png")
                end   
            end
            if rotA < 10 and rotA >= 5 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneLeft1.png")
                else
                    player:setSpriteFrame("planeGlodLeft1.png")
                end  
            end
            if rotA < 15 and rotA >= 10 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneLeft2.png")
                else
                    player:setSpriteFrame("planeGlodLeft2.png")
                end  
            end
            if rotA >= 15 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneLeft3.png")
                else
                    player:setSpriteFrame("planeGlodLeft3.png")
                end  
            end
        ...
        elseif _state == FlyState.RIGHT then 
            ...
            if rotA < 5 then              
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneRight0.png") 
                else
                    player:setSpriteFrame("planeGlodRight0.png")
                end   
            end
            if rotA < 10 and rotA >= 5 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneRight1.png") 
                else
                    player:setSpriteFrame("planeGlodRight1.png")
                end
            end
            if rotA < 15 and rotA >= 10 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneRight2.png") 
                else
                    player:setSpriteFrame("planeGlodRight2.png")
                end
            end
            if rotA >= 15 then
                if isYellowSelect == false then
                    player:setSpriteFrame("PlaneOneRight3.png") 
                else
                    player:setSpriteFrame("planeGlodRight3.png")
                end
            end
        end  
...
--        curLabel:setString(rt_Normal)
        ...
        if isGuide == false then
            ...
            if currentLanguageType == cc.LANGUAGE_CHINESE then
                ...
                distanceText:setString(distance.."m")
            end
...
--                        label:setVisible(false)
                        if currentLanguageType == cc.LANGUAGE_CHINESE then
                            ...
                            label:setString("Becareful missile!!!")
                        end

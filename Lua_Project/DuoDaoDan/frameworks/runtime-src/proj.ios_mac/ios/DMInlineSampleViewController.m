...
#define DMPUBLISHERID        @"56OJzdfIuN4jUMnEOh"
#define DMPLCAEMENTID_BANNER @"16TLmqUoApzUANUOxHcFogzk"
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        _adY = [[UIScreen mainScreen] bounds].size.height-FLEXIBLE_SIZE.height;
    }
    return self;
}

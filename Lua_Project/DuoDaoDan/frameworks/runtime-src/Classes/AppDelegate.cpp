...
{
    ZipUtils::setPvrEncryptionKey(0x2bdb868b, 0x58bf7510, 0x96992ea0, 0x7c25e977);
    ...
    stack->setXXTEAKeyAndSign("fireflysoft", strlen("fireflysoft"), "duodaodan", strlen("duodaodan"));

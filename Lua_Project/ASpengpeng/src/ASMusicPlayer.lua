...
function ASMusicPlayer:loadAllMusic()
	...
	local allTheMusic = {
	button = "res/effectMusic/button.wav",
	dead = "res/effectMusic/dead.wav",
	point = "res/effectMusic/point.wav",
	jump = "res/effectMusic/jump.wav",
	getMoney = "res/effectMusic/getMoney.mp3"
	}
...
function ASMusicPlayer:currentPlayEffect(aEffectFileName,isLoop)
    ...
    local fileName = "res/effectMusic/"..tostring(aEffectFileName)
